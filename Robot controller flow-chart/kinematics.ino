...
float stored_0x = 0.f;
void handle_kinematics(datatypes::Vector2D _dir, float _turn, float _height, float period) { ///運動學fn
  for (int l = 0; l < 4; l++) {
...
float c_base(float angle1) { ///base計算fn
...
datatypes::Rotator c_triangle(float a0, float a1, float b0) { ///計算三角度數值
  float angle1 = a1;
